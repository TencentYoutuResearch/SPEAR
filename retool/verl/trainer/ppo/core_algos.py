...
def agg_loss(loss_mat: torch.Tensor, loss_mask: torch.Tensor, loss_agg_mode: str, rollout_n=None):
    """
...
def compute_policy_loss(
    ...
    # Importance sampling ratio should be clipped ?
    # negative_approx_kl = torch.clamp(negative_approx_kl, min=-20.0, max=1.03)
    ...
    pg_loss = agg_loss(loss_mat=pg_losses, loss_mask=response_mask, loss_agg_mode=loss_agg_mode, rollout_n=rollout_n)
