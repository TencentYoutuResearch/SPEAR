...
class PolicyLossConfig(BaseConfig):
    ...
    clip_cov_ratio_replay: float = 0.8
    clip_cov_lb_replay: float = 0.1
    clip_cov_ub_replay: float = 10.0
    kl_cov_ratio_replay: float = 0.8
...
class ActorConfig(BaseConfig):
    ...
    enable_trajectory_replay: bool = False
    enable_trajectory_posadv: bool = False
    weight_decay_trajectory_replay: float = 0.9
    trajectory_buffer_size: int = 2048
    baseline_buffer_size: int = 10240
    trajectory_score_threshold: int = 1
    trajectory_tolerate_steps: int = 10
    ...
    replay_loss_coef: float = 0.001
    max_replay_loss_steps: int = 200
