...
class SGLangRollout(BaseRollout):
    ...
    def _req_level_generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        for req in sorted_output_req_list:
            ...
            tools = [tool.model_dump() for tool in req.tool_schemas] if req.tool_schemas else []
            messages.append({"messages": req.messages, "tools": tools})
        ...
        non_tensor_batch = {
            ...
            "download_list": np.array(download_list),
        }
