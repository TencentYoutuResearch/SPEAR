...
def test_prime_code():
    ...
    for completion, ground_truth, score_ in zip(prime_code_answers, prime_code_gts, prime_code_scores, strict=False):
...
def test_prime_math():
    ...
    for completion, ground_truth in zip(prime_math_answers, prime_math_gts, strict=False):
        score = default_compute_score(data_source, completion, ground_truth)
