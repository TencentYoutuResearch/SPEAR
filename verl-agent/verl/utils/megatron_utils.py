...
def default_tp_concat_fn(
    layer_name_mapping, name, train_params, infer_params, model_config, convert_qkv_gate_up_by_simple_split=False
):
    """
        ...
        if ".mlp.experts.linear_fc" in cur_name and ep_size > 1:
            ...
            for name, param in zip(global_expert_names, infer_params, strict=False):
                ...
                merge_params = default_tp_concat_fn(
                    layer_name_mapping, name, broad_pp_tensor, params, model_config, convert_qkv_gate_up_by_simple_split
                )
